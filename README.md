...
Aerodynamic optimization of paper airplanes. Over Engineer 09/12.
...
```bash
git clone https://github.com/Vitalcheffe/over-engineer-paperplane.git
cd over-engineer-paperplane
